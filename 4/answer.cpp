...
#include <string.h>
#include <iostream>
unsigned long long int dp[19][7][19][19];
				...
				if(last_number == 4) {
					for(int n_4 = 1; n_4 <= 18; ++n_4) {
						for(int n_7 = 0; n_7 <= 18; ++n_7) {
							dp[n_digit][overall_mod_7][n_7][n_4]
							 += dp[n_digit-1][mod_7][n_7][n_4 - 1];
						}
					}
...
unsigned long long int n_lucky_tens( int first_number, int exp, int plus_mod_7, int plus_n_7, int plus_n_4 ) {
	std::cout << first_number << " @ pos " << exp << ", acc_mod = " << plus_mod_7 << ", n7 = " << plus_n_7 << ", n4 = " << plus_n_4 << std::endl;
	...
	for(int last_number = 0; last_number < first_number; ++last_number) {
		...
		std::cout << " > searching " << last_number << " @ pos " << exp << ", mod = " << previous_mod_7 << std::endl;
		...
		if(last_number == 4) {
			    ...
			    n_7 <= 18 - plus_n_7; ++n_7)
			{
				for(int n_4 = 0; n_4 + plus_n_4 + 1 < n_7 + plus_n_7; ++n_4) {
					...
					std::cout << " > searching " << last_number << " @ pos " << exp << ", mod = " << previous_mod_7 << ", n7 = " << n_7 << ", n4 = " << n_4 << std::endl;
				}
			}
		} else if(last_number == 7) {
